import pytest
from .request_log_get_error_rate_service_view import RequestLogGetErrorRateServiceView
...
class RequestLogControllerMock:
    ...
    async def get_error_rate_service(self, service: str):
        self.get_called = True
        self.service = service

@pytest.mark.asyncio
async def test_handle_get_error_rate_service():
    controller_mock = RequestLogControllerMock()
    view = RequestLogGetErrorRateServiceView(controller_mock)
